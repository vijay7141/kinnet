...
<div className="dash_header">
  ...
  <div className="dash_notify_icon"> 
      <img src="/icn/fi-rr-bell.svg" alt="logo" className="" />
  </div>
  ...
  <div className="dash_user_avatar">
    <img src="/icn/user_avatar.svg" alt="user" />
     ...
     <button className="mobile_side_show" onClick={toggleSidebar}>
      <img src="/icn/navs.svg" alt="user" />
   </button>
</div>
    </div>
  );
